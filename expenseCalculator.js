        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                //INSERT YOUR CODE BELOW
            // Compute tax for married filing seperately
               if (income <= 9275){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
          ...
          *******************************************************************************/
                ...
                //INSERT YOUR CODE BELOW
            // Compute tax for filing as head of household
               if (income <= 13250){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
...
function clearButton () {
             ...
             //INSERT YOUR CODE BELOW
        //This code resets the dropdown box to the "Married Filing Jointly" filer status.
              document.getElementById("filingStatus").selectedIndex = 1;
        //This code resets the dropdown box to the "Married Filing Seperately" filer status.
